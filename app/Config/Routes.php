...
$routes->get('pemusnahanAsetIt', 'RincianAset::pemusnahanAsetIt');
...
$routes->get('pemusnahanAsetIt/dataDestroyaGeneratePDF', 'RincianAset::dataDestroyaGenerateItPDF');
$routes->get('pemusnahanAsetIt/exportDestroyFile', 'RincianAset::exportDestroyItFile');
...
$routes->post('pemusnahanItAset/delete/(:any)', 'RincianAset::pemusnahanAsetItDelete/$1');
