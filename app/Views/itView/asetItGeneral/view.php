...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    ...
    <div class="d-flex align-items-center flex-wrap text-nowrap">
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            <a href="<?= site_url('asetItGeneral/generatePDF') ?>" target="_blank"
                class="btn btn-primary btn-icon-text me-2 mb-2 mb-md-0">
                <i class=" btn-icon-prepend" data-feather="download"></i>
                Download PDF
            </a>
            <a href="<?= site_url('asetItGeneral/export') ?>" class="btn btn-success btn-icon-text me-2 mb-2 mb-md-0">
                <i class=" btn-icon-prepend" data-feather="download"></i>
                Download Excel
            </a>
        </div>
                    ...
                    <table class="table table-hover" id="dataTable" style="width: 100%;">
                        ...
                        <tbody class="py-2">
                            ...
                            <tr style="padding-top: 10px; padding-bottom: 10px; vertical-align: middle;">
                                ...
                                <td class="text-center">
                                    <a href="<?=site_url('asetItGeneral/'.$value->idIdentitasSarana) ?>"
