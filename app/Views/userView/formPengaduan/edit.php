...
<div class="row">
    <div class="col-12 col-xl-12 grid-margin stretch-card">
        <div class="card overflow-hidden">
            <div class="card-body">
                <form action="<?= site_url('pertanyaanPengaduan/'.$dataPertanyaanPengaduan->idPertanyaanPengaduan)?>" method="post" autocomplete="off"  id="custom-validation">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="pertanyaanPengaduan" name="pertanyaanPengaduan"
                                placeholder="Masukkan pertanyaan" value="<?=$dataPertanyaanPengaduan->pertanyaanPengaduan?>" >
                        </div>
                    </div>                    
                    <div class="row mb-3">
