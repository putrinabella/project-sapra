                ...
                <div class="table-responsive">
                    <table class="table table-hover" id="my-table" style="width: 100%;">
                        ...
                        <tbody class="py-2">
                            ...
                            <?php
                                $averagePercentage = ($sumFeedback / ($totalFeedback * 5)) * 100; // Calculate average as percentage
                                $averagePercentage = max(0, min(100, $averagePercentage)); // Ensure the result is within the range [0, 100]
                                ?>
                            <tr>
