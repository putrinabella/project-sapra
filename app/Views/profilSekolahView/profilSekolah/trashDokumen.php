...
<?= $this->section("title"); ?>
<title>Recycle Bin Dokumen Sekolah &verbar; SARPRA </title>
<?= $this->endSection(); ?>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                    ...
                    <div class="d-flex align-items-center flex-wrap text-nowrap">
                        ...
                        <form action="<?= site_url('profilSekolah/deletePermanent/') ?>" method="POST"
                   ...
                   <table class="table table-hover" id="dataTable" style="width: 100%;">
                        ...
                        <?php foreach ($dataDokumenSekolah as $key => $value) : ?>
                            <tr style="padding-top: 10px; padding-bottom: 10px; vertical-align: middle;">
                                ...
                                <td class="text-center"> <?= $value->namaDokumenSekolah; ?> </td>
                                <td class="text-center">
