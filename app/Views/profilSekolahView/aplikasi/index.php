...
<?= $this->section("title"); ?>
<title>Aplikasi &verbar; SARPRA </title>
<?= $this->endSection(); ?>
...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    ...
    <div class="d-flex align-items-center flex-wrap text-nowrap">
        <a href="<?= site_url('aplikasi/trash') ?>" class="btn btn-danger btn-icon-text me-2 mb-2 mb-md-0">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="<?= site_url('aplikasi/createTemplate') ?>">Download Template</a>
                <a class="dropdown-item" href="" data-bs-toggle="modal" data-bs-target="#modalImport">Upload Excel</a>
            </div>
        </div>
        <a href="<?= site_url('aplikasi/new') ?>" class="btn btn-primary btn-icon-text mb-2 mb-md-0">
