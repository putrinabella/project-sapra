...
<?= $this->section("title"); ?>
<title>Recycle Bin TagihanAir &verbar; SARPRA </title>
<?= $this->endSection(); ?>

<?= $this->section("content"); ?>

<h4 class="mb-3 mb-md-0">Recyle Bin Data TagihanAir</h4>
<br>
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <?php foreach ($dataTagihanAir as $key => $value) : ?>
                            <tr style="padding-top: 10px; padding-bottom: 10px; vertical-align: middle;">
                                ...
                                <td class="text-center">
                                    <a href="<?=site_url('tagihanAir/restore/'.$value->idTagihanAir) ?>"
                                        class="btn btn-primary"> Restore</a>
                                    <form action="<?= site_url('tagihanAir/deletePermanent/'.$value->idTagihanAir) ?>"
