            ...
            <div class="card-body">
                <form action="<?= site_url('tagihanAir')?>" method="post" autocomplete="off"  id="custom-validation">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                        <select class="js-example-basic-single form-select select2-hidden-accessible" data-width="100%" data-select2-id="1"  aria-hidden="true" id="bulanPemakaianAir" name="bulanPemakaianAir">
