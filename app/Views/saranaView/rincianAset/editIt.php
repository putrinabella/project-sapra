...
<div class="row">
    <div class="col-12 col-xl-12 grid-margin stretch-card">
        <div class="card overflow-hidden">
            ...
            <div class="card-body">
                <form action="<?= site_url('dataItSarana/'.$dataRincianAset->idRincianAset)?>" method="post"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="kodeRincianAset" name="kodeRincianAset"
                                placeholder="Kode akan dibuat secara otomatis" value=" <?= $dataRincianAset->kodeRincianAset; ?> "; readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
