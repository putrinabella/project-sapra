...
<?= $this->section("title"); ?>
<title>Recycle Bin Layanan Non Aset Sarana &verbar; SARPRA </title>
<?= $this->endSection(); ?>
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?= site_url('saranaLayananNonAset')?>">Layanan Non Aset</a></li>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                    ...
                    <div class="d-flex align-items-center flex-wrap text-nowrap">
                        <a href="<?= site_url('saranaLayananNonAset/restore')?>"
                            class="btn btn-primary btn-icon-text  me-2 mb-2 mb-md-0">
                            <i class="btn-icon-prepend" data-feather="cloud-drizzle"></i>
                            Restore All
                        </a>
                        <form action="<?= site_url('saranaLayananNonAset/deletePermanent/') ?>" method="POST"
                   ...
                   <table class="table table-hover" id="dataTable">
                        ...
                        <?php foreach ($dataSaranaLayananNonAset as $key => $value) : ?>
                            <tr style="padding-top: 10px; padding-bottom: 10px; vertical-align: middle;">
                                ...
                                <td class="text-center">
                                    <a href="<?=site_url('saranaLayananNonAset/restore/'.$value->idSaranaLayananNonAset) ?>"
                                        class="btn btn-primary"> Restore</a>
                                    <form action="<?= site_url('saranaLayananNonAset/deletePermanent/'.$value->idSaranaLayananNonAset) ?>"
