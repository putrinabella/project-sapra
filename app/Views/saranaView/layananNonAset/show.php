            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                ...
                <table class="table">
                    <tr>
                        ...
                        <td style="width: 5%;">:</td>
                        <td><?= $dataSaranaLayananNonAset->tanggal?></td>
                    </tr>
                    <tr>
                        <td>Lokasi</td>
                        <td>:</td>
                        <td><?= $dataSaranaLayananNonAset->namaPrasarana?></td>
                    </tr>
                    <tr>
                        <td>Status Layanan</td>
                        <td>:</td>
                        <td><?= $dataSaranaLayananNonAset->namaStatusLayanan?></td>
                    </tr>
                    <tr>
                        <td>Kategori Manajemen</td>
                        <td>:</td>
                        <td><?= $dataSaranaLayananNonAset->namaKategoriManajemen?></td>
                    </tr>
                    <tr>
                        <td>Sumber Dana</td>
                        <td>:</td>
                        <td><?= $dataSaranaLayananNonAset->namaSumberDana?></td>
                    </tr>
                    <tr>
                        <td>Biaya</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td>Link Bukti</td>
                        <td>:</td>
                        <td><?= $dataSaranaLayananNonAset->bukti?></td>
                    </tr>
                    <tr>
                        <td>Keterangan</td>
                        <td>:</td>
