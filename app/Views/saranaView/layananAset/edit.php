                        ...
                        <div class="col-sm-9">
                            <div class="input-group date datepicker" id="tanggal">
                                <input type="text" class="form-control bg-transparent" name="tanggal"
                                    value="<?=$dataSaranaLayananAset->tanggal?>">
                        ...
                        <div class="col-sm-9">
                            <select class="js-example-basic-single form-select select2-hidden-accessible"
                                ...
                                <option value="<?= $value->idIdentitasSarana ?>" <?php echo ($value->idIdentitasSarana
                                    == $dataSaranaLayananAset->idIdentitasSarana) ? 'selected' : '' ?>>
                                    <?= $value->namaSarana ?>
                                </option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select class="js-example-basic-single form-select select2-hidden-accessible"
                                ...
                                <option value="<?=$dataSaranaLayananAset->kodeRincianAset?>">
                                    <?=$dataSaranaLayananAset->kodeRincianAset?></option>
                            </select>
                            <input type="text" class="form-control" id="idRincianAset" name="idRincianAset"
                                placeholder="Menampilkan ID rincian aset"
                                value="<?=$dataSaranaLayananAset->idRincianAset?>" hidden>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="idIdentitasPrasarana"
                                ...
                                value="<?=$dataSaranaLayananAset->namaPrasarana?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="idKategoriManajemen" name="idKategoriManajemen"
                                ...
                                value="<?=$dataSaranaLayananAset->namaKategoriManajemen?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select class="js-example-basic-single form-select select2-hidden-accessible"
                                ...
                                <option value="<?= $value->idStatusLayanan ?>" <?php echo ($value->idStatusLayanan ==
                                    $dataSaranaLayananAset->idStatusLayanan) ? 'selected' : '' ?>>
                        ...
                        <div class="col-sm-9">
                            <select class="js-example-basic-single form-select select2-hidden-accessible"
                                ...
                                <option value="<?= $value->idSumberDana ?>" <?php echo ($value->idSumberDana ==
                                    $dataSaranaLayananAset->idSumberDana) ? 'selected' : '' ?>>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="bukti" name="bukti"
                                placeholder="Masukkan link dokumentasi (Link Google Drive)" value="<?=$dataSaranaLayananAset->bukti?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="keterangan" name="keterangan" rows="4"
                                placeholder="Masukkan keterangan layanan"><?=$dataSaranaLayananAset->keterangan?></textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
