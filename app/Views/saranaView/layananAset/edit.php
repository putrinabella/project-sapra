                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group date datepicker" id="tanggal">
                                <input type="text" class="form-control" name="tanggal"  value="<?=$dataSaranaLayananAset->tanggal?>">
                        ...
                        <div class="col-sm-9">
                            <select class="js-example-basic-single form-select select2-hidden-accessible" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true" id="idIdentitasSarana" name="idIdentitasSarana">
                                ...
                                <?php foreach ($dataIdentitsaSarana as $key => $value): ?>
                                    <option value="<?= $value->idIdentitasSarana ?>" <?php echo ($value->idIdentitasSarana == $dataSaranaLayananAset->idIdentitasSarana) ? 'selected' : '' ?>>
                                        <?= $value->namaSarana ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="idIdentitasPrasarana" name="idIdentitasPrasarana"
                                placeholder="Masukkan Lokasi" value="<?=$dataSaranaLayananAset->namaPrasarana?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <input type="text" class="form-control" id="idKategoriManajemen" name="idKategoriManajemen"
                                placeholder="Masukkan Kategori Aset" value="<?=$dataSaranaLayananAset->namaKategoriManajemen?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select class="js-example-basic-single form-select select2-hidden-accessible" data-width="100%" data-select2-id="3" tabindex="-1" aria-hidden="true" id="idStatusLayanan" name="idStatusLayanan">
                                ...
                                <?php foreach ($dataStatusLayanan as $key => $value): ?>
                                    <option value="<?= $value->idStatusLayanan ?>" <?php echo ($value->idStatusLayanan == $dataSaranaLayananAset->idStatusLayanan) ? 'selected' : '' ?>>
                        ...
                        <div class="col-sm-9">
                            <select class="js-example-basic-single form-select select2-hidden-accessible" data-width="100%" data-select2-id="4" tabindex="-1" aria-hidden="true"  id="idSumberDana" name="idSumberDana">
                                ...
                                <?php foreach ($dataSumberDana as $key => $value): ?>
                                    <option value="<?= $value->idSumberDana ?>" <?php echo ($value->idSumberDana == $dataSaranaLayananAset->idSumberDana) ? 'selected' : '' ?>>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="biaya" name="biaya"
                                placeholder="Masukkan biaya" value="<?=$dataSaranaLayananAset->biaya?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="bukti" class="col-sm-3 col-form-label">Bukti Dokumentasi</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="bukti" name="bukti" placeholder="Masukkan link dokumentasi" value="<?=$dataSaranaLayananAset->bukti?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="keterangan" class="col-sm-3 col-form-label">Keterangan</label>
                        <div class="col-sm-9">
                            <textarea class="form-control" id="keterangan" name="keterangan" rows="4" placeholder="Masukkan keterangan layanan"><?=$dataSaranaLayananAset->keterangan?></textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
