                ...
                <form action="<?= site_url('dataAsetPeminjaman/' . $dataDataAsetPeminjaman->idManajemenAsetPeminjaman) ?>"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control bg-transparent" id="namaPeminjam" name="namaPeminjam"
                                value="<?= $dataDataAsetPeminjaman->namaSiswa ?>" readonly>
                            <input type="text" class="form-control bg-transparent" id="idManajemenAsetPeminjaman"
                                name="idManajemenAsetPeminjaman" value="<?= $dataDataAsetPeminjaman->idManajemenAsetPeminjaman ?>"
                                hidden>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control bg-transparent" id="keperluanAlat"
                                name="keperluanAlat" value="<?= $dataDataAsetPeminjaman->keperluanAlat ?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9" id="tanggalPengembalianContainer">
                            <div class="input-group date datepicker" id="tanggalPengembalian">
                                <input type="readonly" class="form-control bg-transparent border-primary"
                                    ...
                                    value="<?= $dataDataAsetPeminjaman->tanggalPengembalian ?>">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-12 text-end">
                            <a href="<?= site_url('dataAsetPeminjaman') ?>" class="btn btn-secondary me-2">Cancel</a>
