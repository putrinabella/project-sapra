    ...
    <div>
        <form action="<?= site_url('requestAsetPeminjaman') ?>" class="d-flex align-items-center flex-wrap text-nowrap">
            ...
            <div class="col py-3 p-0 mb-2 mb-md-0">
                ...
                <a href="<?= site_url('requestAsetPeminjaman') ?>" class="btn btn-success btn-icon ">
        ...
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            <?php
                if (empty($_GET['startDate']) && empty($_GET['endDate'])) {
                    $exportLink = site_url('requestAsetPeminjaman/export');
                    $generatePDFLink = site_url('requestAsetPeminjaman/generatePDF');
                } else {
                    $startDate = $_GET['startDate'] ?? '';
                    $endDate = $_GET['endDate'] ?? '';
                    $exportLink = site_url("requestAsetPeminjaman/export?startDate=$startDate&endDate=$endDate");
                    $generatePDFLink = site_url("requestAsetPeminjaman/generatePDF?startDate=$startDate&endDate=$endDate");
                }
            ?>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover" id="dataTable" style="width: 100%;">
                    ...
                    <tbody class="py-2">
                        <?php foreach ($dataRequestAsetPeminjaman as $key => $value) : ?>
