        ...
        <div class="card overflow-hidden">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <a href="<?= site_url('requestAsetPeminjaman') ?>" class="btn btn-icon-text btn-outline-primary me-2">
            ...
            <div class="card-body">
                <form action="<?= site_url('requestAsetPeminjaman/processLoan') ?>" method="POST" autocomplete="off"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control bg-transparent" name="tanggal"
                                placeholder="Masukkan tanggal" readonly value="<?= $dataRequestAsetPeminjaman->tanggal ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control bg-transparent" id="nis" name="nis"
                                value="<?= $dataRequestAsetPeminjaman->nis ?>" readonly>
                            <input type="text" class="form-control bg-transparent" id="asalPeminjam" name="asalPeminjam"
                                value="<?= $dataRequestAsetPeminjaman->idDataSiswa ?>" hidden>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control bg-transparent" id="namaPeminjam" name="namaPeminjam"
                                value="<?= $dataRequestAsetPeminjaman->namaSiswa ?>" readonly>
                            <input type="text" class="form-control bg-transparent" id="idRequestAsetPeminjaman"
                                name="idRequestAsetPeminjaman" value="<?= $dataRequestAsetPeminjaman->idRequestAsetPeminjaman ?>"
                                hidden>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control bg-transparent" id="jumlahPeminjaman"
                                name="jumlahPeminjaman" value="<?= $dataRequestAsetPeminjaman->jumlahPeminjaman ?> Aset"
                                readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control bg-transparent" id="keperluanAlat"
                                name="keperluanAlat" value="<?= $dataRequestAsetPeminjaman->keperluanAlat ?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control bg-transparent" id="lamaPinjam" name="lamaPinjam"
                                value="<?= $dataRequestAsetPeminjaman->lamaPinjam ?> Hari" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-12 text-end">
                            <a href="<?= site_url('requestAsetPeminjaman/rejectLoan/' . $value->idRequestAsetPeminjaman) ?>"
