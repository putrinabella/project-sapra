...
<?= $this->section("title"); ?>
<title>Recycle Bin Identitas Lantai &verbar; SARPRA </title>
<?= $this->endSection(); ?>
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?= site_url('identitasLantai')?>">Identitas Lantai</a></li>
        ...
        <div class="card overflow-hidden">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                    <div>
                        <a href="<?= site_url('identitasLantai')?>"
                   ...
                   <table class="table table-hover" id="dataTable" style="width: 100%;">
                        <thead>
                            <tr class="text-center">
                                ...
                                <th style="width: 15%;">ID Identitas Lantai</th>
                                <th>Nama Lantai</th>
                        ...
                        <tbody class="py-2">
                            ...
                            <tr style="padding-top: 10px; padding-bottom: 10px; vertical-align: middle;">
                                ...
                                <td class="text-center">
                                    <?= sprintf('%03d', $value->idIdentitasLantai) ?>
                                </td>
                                <td class="text-left"><?=$value->namaLantai?></td>
                                <td class="text-center">
                                    <a href="<?=site_url('identitasLantai/restore/'.$value->idIdentitasLantai) ?>"
                                        class="btn btn-primary"> Restore</a>
                                    <form action="<?= site_url('identitasLantai/deletePermanent/'.$value->idIdentitasLantai) ?>"
