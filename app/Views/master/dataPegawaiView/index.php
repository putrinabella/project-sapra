...
<?= $this->section("title"); ?>
<title>Data Pegawai &verbar; SARPRA </title>
<?= $this->endSection(); ?>
...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    ...
    <div class="d-flex align-items-center flex-wrap text-nowrap">
        <a href="<?= site_url('dataPegawai/trash') ?>" class="btn btn-danger btn-icon-text me-2 mb-2 mb-md-0">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="<?= site_url('dataPegawai/export') ?>">Download as Excel</a>
                <a class="dropdown-item" target="_blank" href="<?= site_url('dataPegawai/generatePDF') ?>">Download as PDF</a>
            </div>
        </div>
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="<?= site_url('dataPegawai/createTemplate') ?>">Download Template</a>
                <a class="dropdown-item" href="" data-bs-toggle="modal" data-bs-target="#modalImport">Upload Excel</a>
            </div>
        </div>
        <a href="<?= site_url('dataPegawai/new') ?>" class="btn btn-primary btn-icon-text mb-2 mb-md-0">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-hover"  id="dataTable" style="width: 100%;">
                        ...
                        <tbody class="py-2">
                        <?php foreach ($dataDataPegawai as $key => $value) : ?>
...
<div class="modal fade" id="modalImport" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?=site_url("dataPegawai/import")?>" method="POST" enctype="multipart/form-data"  id="custom-validation">
