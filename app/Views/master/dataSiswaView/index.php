...
<?= $this->section("title"); ?>
<title>Data Siswa &verbar; SARPRA </title>
<?= $this->endSection(); ?>
...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    ...
    <div class="d-flex align-items-center flex-wrap text-nowrap">
        <a href="<?= site_url('dataSiswa/trash') ?>" class="btn btn-danger btn-icon-text me-2 mb-2 mb-md-0">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="<?= site_url('dataSiswa/export') ?>">Download as Excel</a>
                <a class="dropdown-item" target="_blank" href="<?= site_url('dataSiswa/generatePDF') ?>">Download as PDF</a>
            </div>
        </div>
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="<?= site_url('dataSiswa/createTemplate') ?>">Download Template</a>
                <a class="dropdown-item" href="" data-bs-toggle="modal" data-bs-target="#modalImport">Upload Excel</a>
            </div>
        </div>
        <a href="<?= site_url('dataSiswa/new') ?>" class="btn btn-primary btn-icon-text mb-2 mb-md-0">
                    ...
                    <table class="table table-hover"  id="dataTable" style="width: 100%;">
                        ...
                        <?php foreach ($dataDataSiswa as $key => $value) : ?>
                            <tr style="padding-top: 10px; padding-bottom: 10px; vertical-align: middle;">
                                ...
                                <td class="text-center">
                                    <a href="<?=site_url('dataSiswa/'.$value->idDataSiswa.'/edit') ?>"
                                        class="btn btn-primary btn-icon"> <i data-feather="edit-2"></i></a>
                                    <form action="<?=site_url('dataSiswa/'.$value->idDataSiswa)?>"
...
<div class="modal fade" id="modalImport" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?=site_url("dataSiswa/import")?>" method="POST" enctype="multipart/form-data"  id="custom-validation">
