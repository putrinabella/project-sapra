...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    ...
    <div class="d-flex align-items-center flex-wrap text-nowrap">
        <a href="<?= site_url('manajemenUser/new') ?>" class="btn btn-primary btn-icon-text mb-2 mb-md-0">
...
<div class="modal fade" id="modalImport" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?=site_url("manajemenUser/import")?>" method="POST" enctype="multipart/form-data"  id="custom-validation">
