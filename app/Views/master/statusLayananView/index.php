    ...
    <div class="d-flex align-items-center flex-wrap text-nowrap">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="<?= site_url('statusLayanan/export') ?>">Download as Excel</a>
                <a class="dropdown-item" target="_blank" href="<?= site_url('statusLayanan/generatePDF') ?>">Download as PDF</a>
            </div>
        </div>
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="<?= site_url('statusLayanan/createTemplate') ?>">Download Template</a>
