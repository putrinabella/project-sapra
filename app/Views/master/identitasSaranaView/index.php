    ...
    <div class="d-flex align-items-center flex-wrap text-nowrap">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <a class="dropdown-item" target="_blank" href="<?= site_url('identitasSarana/generatePDF') ?>">Download as PDF</a>
            </div>
        </div>
        <div class="dropdown">
                        ...
                        <tbody class="py-2">
                            ...
                            <tr style="padding-top: 10px; padding-bottom: 10px; vertical-align: middle;">
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="<?=site_url('identitasSarana/delete/'.$value->idIdentitasSarana)?>"
                                        method="post" class="d-inline"  id="del-<?= $value->idIdentitasSarana;?>">
...
<div class="modal fade" id="modalImport" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?=site_url("identitasSarana/import")?>" method="POST" enctype="multipart/form-data"  id="custom-validation">
