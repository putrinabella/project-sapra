        ...
        <div class="card overflow-hidden">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                    <div>
                        <a href="<?= site_url('kategoriManajemen')?>"
                    ...
                    <div class="d-flex align-items-center flex-wrap text-nowrap">
                        <a href="<?= site_url('kategoriManajemen/restore')?>"
                            class="btn btn-primary btn-icon-text  me-2 mb-2 mb-md-0">
                            <i class="btn-icon-prepend" data-feather="cloud-drizzle"></i>
                            Restore All
                        </a>
                        <form action="<?= site_url('kategoriManajemen/deletePermanent/') ?>" method="POST"
                        ...
                        <tbody class="py-2">
                            ...
                            <tr style="padding-top: 10px; padding-bottom: 10px; vertical-align: middle;">
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="<?= site_url('kategoriManajemen/deletePermanent/'.$value->idKategoriManajemen) ?>"
