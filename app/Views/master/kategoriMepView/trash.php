...
<?= $this->section("title"); ?>
<title>Recycle Bin Kategori MEP &verbar; SARPRA </title>
<?= $this->endSection(); ?>
                   ...
                   <table class="table table-hover" id="dataTable" style="width: 100%;">
                        ...
                        <tbody class="py-2">
                            ...
                            <tr style="padding-top: 10px; padding-bottom: 10px; vertical-align: middle;">
                                ...
                                <td class="text-center">
                                    <a href="<?=site_url('kategoriMep/restore/'.$value->idKategoriMep) ?>"
                                        class="btn btn-primary"> Restore</a>
                                    <form action="<?= site_url('kategoriMep/deletePermanent/'.$value->idKategoriMep) ?>"
