...
<div class="row">
    <div class="col-12 col-xl-12 grid-margin stretch-card">
        <div class="card overflow-hidden">
            ...
            <div class="card-body">
                <form action="<?= site_url('manajemenStok')?>" method="post" enctype="multipart/form-data" autocomplete="off" id="custom-validation">
                    <?= csrf_field() ?>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-12 text-end">
                            <a href="<?= site_url('manajemenStok') ?>" class="btn btn-secondary me-2">Cancel</a>
