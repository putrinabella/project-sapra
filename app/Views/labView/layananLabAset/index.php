...
<?= $this->section("title"); ?>
<title>Layanan Aset Laboratorium &verbar; SARPRA </title>
<?= $this->endSection(); ?>
...
<div>
    ...
    <div class="d-flex align-items-center flex-wrap text-nowrap">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="<?= site_url('layananLabAset/createTemplate') ?>">Download Template</a>
                <a class="dropdown-item" href="" data-bs-toggle="modal" data-bs-target="#modalImport">Upload Excel</a>
            </div>
        </div>
        <a href="<?= site_url('layananLabAset/new') ?>" class="btn btn-primary btn-icon-text mb-2 mb-md-0">
    ...
    <div class="col-12 col-xl-12 grid-margin stretch-card">
        <div class="card overflow-hidden">
            <div class="card-body">
                ...
                <h4 class="text-center py-3">Layanan Aset Laboratorium</h4>
                    ...
                    <table class="table table-hover" id="dataTable" style="width: 100%;">
                        ...
                        <?php foreach ($dataLayananLabAset as $key => $value) : ?>
                            <tr style="padding-top: 10px; padding-bottom: 10px; vertical-align: middle;">
                                ...
                                <td class="text-center">
                                    <a href="<?=site_url('layananLabAset/'.$value->idLayananLabAset) ?>" class="btn btn-secondary btn-icon"> <i data-feather="info"></i></a>
                                    <a href="<?=site_url('layananLabAset/'.$value->idLayananLabAset.'/edit') ?>"
                                        class="btn btn-primary btn-icon"> <i data-feather="edit-2"></i></a>
                                    <form action="<?=site_url('layananLabAset/'.$value->idLayananLabAset)?>"
                                        method="post" class="d-inline" id="del-<?= $value->idLayananLabAset;?>">
...
<div class="modal fade" id="modalImport" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?=site_url("layananLabAset/import")?>" method="POST" enctype="multipart/form-data"  id="custom-validation">
