...
<div class="row">
    <div class="col-12 col-xl-12 grid-margin stretch-card">
        <div class="card overflow-hidden">
            ...
            <div class="card-body">
                <form action="<?= site_url('layananLabNonAset/'.$dataLayananLabNonAset->idLayananLabNonAset)?>"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group date datepicker" id="tanggal">
                                <input type="text" class="form-control bg-transparent" name="tanggal"  value="<?=$dataLayananLabNonAset->tanggal?>">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="biaya" name="biaya"
                                value="<?=$dataLayananLabNonAset->biaya?>" placeholder="Masukkan biaya">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="bukti" class="col-sm-3 col-form-label">Bukti Dokumentasi</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="bukti" name="bukti" value="<?=$dataLayananLabNonAset->bukti?>"  placeholder="Masukkan link bukti">
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="spesifikasi" name="spesifikasi" rows="10"
                                placeholder="Masukkan spesifikasi aset"><?=$dataLayananLabNonAset->spesifikasi?></textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
