...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?= site_url('asetLabGeneral')?>">Data General</a></li>
        ...
        <div class="card overflow-hidden">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                    <div>
                        <a href="<?= site_url('asetLabGeneral')?>"
                            class="btn btn-outline-primary btn-icon-text me-2 mb-2 mb-md-0">
                            <i class="btn-icon-prepend" data-feather="arrow-left"></i>
                            Back
                        </a>
                        <!-- <a href="<?= site_url('asetLabGeneral/print/'.$dataRincianLabAset->idRincianLabAset)?>"
                ...
                <div class="table-responsive">
                    <table class="my-table">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <?= $dataRincianLabAset->spesifikasi ?>
                            </td>
                        </tr>
                        <tr>
