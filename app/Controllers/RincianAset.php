...
class RincianAset extends ResourceController
{
    ...
    public function index() {
        $data['dataRincianAset'] = $this->rincianAsetModel->getData();
    ...
    public function delete($id = null) {
        ...
        activityLogs($this->userActionLogsModel, "Soft Delete", "Melakukan soft delete data Sarana - Rincian Aset dengan id $id");
    ...
    public function restore($id = null) {
        $affectedRows = restoreData('tblRincianAset', 'idRincianAset', $id, $this->userActionLogsModel, 'Sarana - Rincian Aset');
    ...
    public function deletePermanent($id = null) {
        $affectedRows = deleteData('tblRincianAset', 'idRincianAset', $id, $this->userActionLogsModel, 'Sarana - Rincian Aset');
    
        if ($affectedRows > 0) {
            return redirect()->to(site_url('rincianAset'))->with('success', 'Data berhasil dihapus');
        } 
    
        return redirect()->to(site_url('rincianAset/trash'))->with('error', 'Tidak ada data untuk dihapus');
    }
        ...
        if($extension == 'xlsx' || $extension == 'xls') {
            ...
            foreach ($theFile as $key => $value) {
                ...
                if ($statusData == "ERROR: empty data") {
                    ...
                    $this->rincianAsetModel->insert($data);
                    $this->generateAndSetKodeRincianAset();
                }
            }
    ...
    public function generatePDF() {
        ...
        $pdfData = pdfRincianAset($dataAsetBagus, $dataAsetRusak, $dataAsetHilang, $title);
    
        
        $filename = 'Sarana - Rincian Aset' . ".pdf";
